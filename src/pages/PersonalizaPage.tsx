...
const BENEFITS = [
  {
    ...
    body: 'Algodón 100% orgánico certificado. Producción bajo demanda para reducir residuos.',
    highlight: false,
    icon: 'plant',
  },
  {
    key: 'dtf',
    title: 'Impresión DTF',
    body: 'Tecnología de impresión directa a film para colores vibrantes, gran detalle y durabilidad superior.',
    highlight: true,
    icon: 'brush',
  },
  {
    key: 'env',
    title: 'Envío express',
    body: 'Recibe tu creación personalizada en 48-72 horas hábiles directamente en tu domicilio.',
    highlight: false,
    icon: 'truck',
  },
] as const
